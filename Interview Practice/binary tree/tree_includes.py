...
print(tree_includes(node_class.a, 'e'))
print(tree_includes(node_class.a, 'j'))
print(tree_includes(node_class.b, 'f'))
print(tree_includes(node_class.b, 'e'))
...
print("===")
print(tree_includes_but_recursive(node_class.a, 'e'))
print(tree_includes_but_recursive(node_class.a, 'j'))
# print(tree_includes(node_class.b, 'e'))